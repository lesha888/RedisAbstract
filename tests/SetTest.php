...
use \Redis;
use RedisAbstract\Exception\RedisException;
use RedisAbstract\Exception\SerializerIsNotSupportedException;
use RedisAbstract\Set;

/**
 * Tests for the {@link \RedisAbstract\Set} class
 * .tests
 */
class SetTest extends AbstractTestCase
{
    ...
    /**
     * @throws \RedisAbstract\Exception\RedisException
     * @expectedException \RedisAbstract\Exception\RedisException
     */
    ...
    /**
     * @expectedException \RedisAbstract\Exception\NotSupportedException
     */
